...
atp2003 <- read_csv(file = "C:/Users/hp/Desktop/M2S1/ADD_R/projet/groupe/tennis_wta/wta_matches_2003.csv")
view(atp2003)

summary(atp2003)
table(atp2003$surface)
table(atp2003$tourney_level)
table(atp2003$draw_size)
table(atp2003$match_num)
