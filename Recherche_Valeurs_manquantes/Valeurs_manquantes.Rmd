...
Pour notre projet sur le circuit féminin de tenis, nous devons identifier les valeurs manquantes afin de les traiter au mieux avant de réaliser nos analyses. 
...
Dans cette base de donnée 29 variables avec des valeurs manquantes dont 4 d'entre elle avec plus de 50% de valeurs manquantes et 19 avec 100%. Les 6 autres variables restantes ont moins de 50% de valeurs manquantes. Ce sont les varibales **winner_rank**, **winner_rank_points**, **loser_rank**, **loser_rank_points**, **winner_ht** et **loser_ht**, elles peuvent être complétées avec une autre BDD. 
...
Dans cette base de donnée 29 variables avec des valeurs manquantes dont 7 d'entre elle avec plus de 50% de valeurs manquantes et 18 avec 100%. Les 4 autres variables restantes ont moins de 50% de valeurs manquantes. Ce sont les varibales **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées.
...
Dans cette base de donnée 30 variables avec des valeurs manquantes dont 6 d'entre elle avec plus de 50% de valeurs manquantes et 19 avec 100%. Les 5 autres variables restantes ont moins de 50% de valeurs manquantes. Ce sont les varibales **winner_age**, **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées.
...
Dans cette base de donnée 29 variables avec des valeurs manquantes dont 6 d'entre elle avec plus de 50% de valeurs manquantes et 19 avec 100%. Les 4 autres variables restantes ont moins de 10% de valeurs manquantes. Ce sont les varibales **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées.
...
Dans cette base de donnée 29 variables avec des valeurs manquantes dont 7 d'entre elle avec plus de 50% de valeurs manquantes et 18 avec 100%. Les 4 autres variables restantes ont moins de 25% de valeurs manquantes. Ce sont les varibales **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées.
...
Dans cette base de donnée 29 variables avec des valeurs manquantes dont 22 d'entre elle avec plus de 40% de valeurs manquantes et 3 avec 100%. Les 4 autres variables restantes ont moins de 5% de valeurs manquantes. Ce sont les varibales **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées. De plus la pluspart des variables avec des valeurs manquantes sont spécifiques aux matchs joués, il y a encore peu de tournois pour lesquels ses données ont été remplis. 
...
Dans cette base de donnée 29 variables avec des valeurs manquantes dont 21 d'entre elle avec plus de 50% de valeurs manquantes et 3 avec 100%. Les 5 autres variables restantes ont moins de 40% de valeurs manquantes. Ce sont les varibales **winner_ht**, **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. La variable **loser_ht** peut aussi être complétée. De plus la pluspart des variables avec des valeurs manquantes sont spécifiques aux matchs joués, il y a encore peu de tournois pour lesquels ses données ont été remplis.
...
Dans cette base de donnée 29 variables avec des valeurs manquantes dont 2 avec moins de 50% de valeurs manquantes, 20 avec plus de 50% de valeurs manquantes et 3 avec 100%. Les 4 autres variables restantes ont moins de 5% de valeurs manquantes. Ce sont les varibales **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées. De plus la pluspart des variables avec des valeurs manquantes sont spécifiques aux matchs joués, il y a encore peu de tournois pour lesquels ses données ont été remplis.
...
Dans cette base de donnée 29 variables avec des valeurs manquantes dont 7 d'entre elle avec plus de 50% de valeurs manquantes et 18 avec 100%. Les 4 autres variables restantes ont moins de 15% de valeurs manquantes. Ce sont les varibales **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées.
...
Dans cette base de donnée 30 variables avec des valeurs manquantes dont 2 avec moins de 40% de valeurs manquantes, 20 avec plus de 50% de valeurs manquantes et 3 avec 100%. Les 5 autres variables restantes ont moins de 5% de valeurs manquantes. Ce sont les varibales **surface**, **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées. De plus la pluspart des variables avec des valeurs manquantes sont spécifiques aux matchs joués, il y a encore peu de tournois pour lesquels ses données ont été remplis.
...
Dans cette base de donnée 29 variables avec des valeurs manquantes dont 7 d'entre elle avec plus de 50% de valeurs manquantes et 18 avec 100%. Les 4 autres variables restantes ont moins de 20% de valeurs manquantes. Ce sont les varibales **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées.
...
Dans cette base de donnée 30 variables avec des valeurs manquantes dont 18 avec moins de 50% de valeurs manquantes, 4 avec plus de 50% de valeurs manquantes et 3 avec 100%. Les 5 autres variables restantes ont moins de 5% de valeurs manquantes. Ce sont les varibales **surface**, **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées. De plus la pluspart des variables avec des valeurs manquantes sont spécifiques aux matchs joués, il y a encore peu de tournois pour lesquels ses données ont été remplis.
...
Dans cette base de donnée 29 variables avec des valeurs manquantes dont 7 d'entre elle avec plus de 50% de valeurs manquantes et 18 avec 100%. Les 4 autres variables restantes ont environ moins de 20% de valeurs manquantes. Ce sont les varibales **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées.
...
Dans cette base de donnée 30 variables avec des valeurs manquantes dont 18 avec moins de 30% de valeurs manquantes, 4 avec plus de 50% de valeurs manquantes et 3 avec 100%. Les 5 autres variables restantes ont environ moins de 5% de valeurs manquantes. Ce sont les varibales **surface**, **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées. De plus la pluspart des variables avec des valeurs manquantes sont spécifiques aux matchs joués, il y a encore peu de tournois pour lesquels ses données ont été remplis.
...
Dans cette base de donnée 29 variables avec des valeurs manquantes dont 18 avec moins de 30% de valeurs manquantes, 4 avec plus de 50% de valeurs manquantes et 3 avec 100%. Les 4 autres variables restantes ont environ moins de 5% de valeurs manquantes. Ce sont les varibales **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées. De plus la pluspart des variables avec des valeurs manquantes sont spécifiques aux matchs joués, il y a encore peu de tournois pour lesquels ses données ont été remplis.
...
Dans cette base de donnée 29 variables avec des valeurs manquantes dont 22 d'entre elle avec plus de 50% de valeurs manquantes et 3 avec 100%. Les 4 autres variables restantes ont environ moins de 25% de valeurs manquantes. Ce sont les varibales **winner_rank**, **winner_rank_points**, **loser_rank** et **loser_rank_points**, elles peuvent être complétées avec une autre BDD. Les variables **winner_ht** et **loser_ht** peuvent aussi être complétées.
